...
### Changed
- Rewrote README to match current feature set with accurate system.xml
  configuration table, live product page links, Quick Answer section,
  and full Quick Links table.
