<?php
/**
 * Standalone install + heartbeat reporter for Panth_ProductTabs.
 *
...
namespace Panth\ProductTabs\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_ProductTabs';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-producttabs';
